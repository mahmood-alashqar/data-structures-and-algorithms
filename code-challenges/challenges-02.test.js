...
const raisedToTheThird = (arr) => {
  // Solution code here...
  const tempArr= arr.map(x => {return Math.pow(x,3);
  });
  return tempArr;
};
...
const addOne = (arr) => {
  // Solution code here...
  const tempArr= arr.map(x => {return x=x+1;
  });
  return tempArr;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const tempArr= arr.map(str => {return `${str}?`;
  });
  return tempArr;
};
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  const tempArr= arr.map(x => {return Math.pow(2,x);
  });
  return tempArr;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  const tempArray = [];
  // arr.forEach(x => {tempArray.pushMath.pow(2,x);
  // });
  // return tempArray;
  for (let i=0;i<arr.length;i++)
  {
    tempArray.pushMath.pow(2,arr[i]);
  }
  return tempArray;
};
...
const charCode = (arr) => {
  // Solution code here...
  const tempArr= arr.map(x => {return charCode([x]);
  });
  return tempArr;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  const tempArr= arr.map(x => {if (x%2 === 0) return 'even';
  else if (x%2 !==0)
    return 'odd';
  else if(x === 0)
    return'zero';
...
const extractAbilities = (arr) => {
  // Solution code here...
  const tempArr= arr.map(() => {return(snorlaxAbilities.abilities.name());
  });
  return tempArr;
};
