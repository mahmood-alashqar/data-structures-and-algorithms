...
const typeNum = (arr) => {
  const newArr = arr.filter(currentTempValue => {
    return(typeof(currentTempValue) === 'number');
  });
  return newArr;
  // Solution code here...
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const newArr = arr.filter(i => {
    return(forbiddenValues.indexOf(i) === -1);
  });
  return newArr ;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  const newArr = arr.filter(tempObj => {
    return(tempObj.baseStat > minBaseStat);
  });
  return newArr ;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  const newArr = getBaseStatGreaterThan(arr,minBaseStat).map(tempObj => {
    return(tempObj.stat.name);
  });
  return newArr ;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  const newArr = arr.filter(charObj => {
...
const evenOddNumericValues = (arr) => {
  ...
  const newArr = filteredArray.map(num => {
    if(num % 2 === 0)
      return 'even';
    else if(num % 1 === 0)
      return 'odd';
