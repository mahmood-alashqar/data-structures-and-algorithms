...
This function should first create a new array. Then iterate over the input array and modify each tempValue based on the callback function provided.
...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  const newArr = [];
  arr.forEach( tempValue => newArr.push(callback(tempValue)));
  return newArr ;
};
